...
import { Sparkles, Facebook, Instagram, Linkedin, Twitter, Image as ImageIcon, Loader2, Music } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-blue-50 to-pink-50">
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        ...
        <div className="text-center mb-12">
          ...
          <Link
            href="/mixer"
            className="inline-flex items-center gap-2 bg-gradient-to-r from-purple-600 to-pink-600 text-white px-6 py-3 rounded-lg font-semibold hover:from-purple-700 hover:to-pink-700 transition-all shadow-lg"
          >
            <Music className="w-5 h-5" />
            Try Digital Turntable Mixer
          </Link>
        </div>
